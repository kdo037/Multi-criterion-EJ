...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 16 15:23:17 2024
...
# for y in range(6,7):
    ...
    # municipalityIncomeScore = np.subtract(100, municipalityIncomeScore20pct)
    # ejScore = np.add(ejScore, municipalityIncomeScore20pct)
    ...
    # baselineEJ = (minorityBase + limEngBase + (100-incomeBase) + (100 - municipalIncomeBase))*0.75
    baselineEJ = (minorityBase + limEngBase + (100-incomeBase))*0.65
    # baselineEJ = (25 + 25 + 65 + 150)*0.75
    ...
    # ############ Zoom in for the Greater Boston ##############
    # plt.xlim([-71.3, -70.9])
    # plt.ylim([42.24, 42.51])
    # ##########################################################
    ...
    plt.savefig('MA_EJ_Score_Map_zoom_in' + str(years[y]) + '.png', dpi=500)
